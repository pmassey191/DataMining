...
From the 350 Trim chart of RMSE versus K, we see that the RMSE bottoms out at `r optk_350`, as such the line of fit against the test data is for that K value. Similarly, we can find an optimal K value for the AMG trim cars.
