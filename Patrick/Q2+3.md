...
![](Q2+3_files/figure-markdown_strict/unnamed-chunk-2-1.png)

![](Q2+3_files/figure-markdown_strict/unnamed-chunk-3-1.png)

The 95th percentile of height for female competitors is: 183
...
stabilizes the mean of the age of the participants. We can the from the
graph that there is an upward trend in both male and female average age
with the age gap shrinking over time.
